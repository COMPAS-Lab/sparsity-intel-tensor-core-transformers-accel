...
# ACDS 20.4 72 win32 2023.01.16.18:46:35
# ----------------------------------------
...
# ----------------------------------------
# If out_asym_fifo is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "out_asym_fifo.out_asym_fifo"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [out_asym_fifo::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [out_asym_fifo::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [out_asym_fifo::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [out_asym_fifo::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [out_asym_fifo::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [out_asym_fifo::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [out_asym_fifo::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
