...
module  out_asym_fifo_fifo_1910_5vttcmy  (
    data,
    rdclk,
    rdreq,
    wrclk,
    ...
    defparam
        ...
        dcfifo_mixed_widths_component.lpm_hint  = "RAM_BLOCK_TYPE=M20K,MAXIMUM_DEPTH=128,DISABLE_DCFIFO_EMBEDDED_TIMING_CONSTRAINT=TRUE",
        dcfifo_mixed_widths_component.lpm_numwords  = 64,
        dcfifo_mixed_widths_component.lpm_showahead  = "ON",
        dcfifo_mixed_widths_component.lpm_type  = "dcfifo_mixed_widths",
        dcfifo_mixed_widths_component.lpm_width  = 1152,
