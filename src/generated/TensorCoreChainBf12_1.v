...
// Component : TensorCoreChainBf12_1
// Git hash  : a8561e868ead1ba45c504d2e34b6133ebfdc8d95

`timescale 1ns/1ps 
module TensorCoreChainBf12_1 (
  ...
  output wire          io_dataIterReady,
  input  wire          io_loadValid,
  output wire          io_loadReady,
  ...
  wire       [5:0]    _zz_loadCounter_valueNext;
  ...
  reg        [5:0]    loadCounter_valueNext;
  reg        [5:0]    loadCounter_value;
  ...
  assign _zz_loadCounter_valueNext = {5'd0, _zz_loadCounter_valueNext_1};
