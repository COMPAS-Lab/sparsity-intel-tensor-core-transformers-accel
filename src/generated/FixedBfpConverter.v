...
module FixedBfpConverter (
  ...
  input  wire [319:0]  io_dataIn_payload,
  output wire          io_dataOut_valid,
  output wire [87:0]   io_dataOut_payload,
  input  wire          clk,
  input  wire          clrn
);
  ...
  assign voidData_mantissa = 23'h000000;
  assign voidData_exp = 8'h00;
  ...
  always @(posedge clk) begin
    if(!clrn) begin
      _zz_exceptionalCompRes_2 <= 8'h00;
      intermediateCompRes_0 <= 8'h00;
      intermediateCompRes_1 <= 8'h00;
      intermediateCompRes_2 <= 8'h00;
      intermediateCompRes_3 <= 8'h00;
      intermediateCompRes_4 <= 8'h00;
      intermediateCompRes_5 <= 8'h00;
      intermediateCompRes_6 <= 8'h00;
      largestExp <= 8'h00;
      ...
      resMants_9 <= 8'h00;
      resExp <= 8'h00;
      _zz_resMants_0 <= 9'h000;
      _zz_resMants_0_1 <= 9'h000;
      _zz_resMants_1 <= 9'h000;
      _zz_resMants_1_1 <= 9'h000;
      _zz_resMants_2 <= 9'h000;
      _zz_resMants_2_1 <= 9'h000;
      _zz_resMants_3 <= 9'h000;
      _zz_resMants_3_1 <= 9'h000;
      _zz_resMants_4 <= 9'h000;
      _zz_resMants_4_1 <= 9'h000;
      _zz_resMants_5 <= 9'h000;
      _zz_resMants_5_1 <= 9'h000;
      _zz_resMants_6 <= 9'h000;
      _zz_resMants_6_1 <= 9'h000;
      _zz_resMants_7 <= 9'h000;
      _zz_resMants_7_1 <= 9'h000;
      _zz_resMants_8 <= 9'h000;
      _zz_resMants_8_1 <= 9'h000;
      _zz_resMants_9 <= 9'h000;
      _zz_resMants_9_1 <= 9'h000;
      _zz_resExp <= 8'h00;
      _zz_resExp_1 <= 8'h00;
    end else begin
      ...
      _zz_resMants_0 <= (((((delayedData_0_signBit == voidData_signBit) && (delayedData_0_mantissa == voidData_mantissa)) && (delayedData_0_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_0_mantissa[22 : 15]}) >>> _zz__zz_resMants_0);
      ...
      _zz_resMants_1 <= (((((delayedData_1_signBit == voidData_signBit) && (delayedData_1_mantissa == voidData_mantissa)) && (delayedData_1_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_1_mantissa[22 : 15]}) >>> _zz__zz_resMants_1);
      ...
      _zz_resMants_2 <= (((((delayedData_2_signBit == voidData_signBit) && (delayedData_2_mantissa == voidData_mantissa)) && (delayedData_2_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_2_mantissa[22 : 15]}) >>> _zz__zz_resMants_2);
      ...
      _zz_resMants_3 <= (((((delayedData_3_signBit == voidData_signBit) && (delayedData_3_mantissa == voidData_mantissa)) && (delayedData_3_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_3_mantissa[22 : 15]}) >>> _zz__zz_resMants_3);
      ...
      _zz_resMants_4 <= (((((delayedData_4_signBit == voidData_signBit) && (delayedData_4_mantissa == voidData_mantissa)) && (delayedData_4_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_4_mantissa[22 : 15]}) >>> _zz__zz_resMants_4);
      ...
      _zz_resMants_5 <= (((((delayedData_5_signBit == voidData_signBit) && (delayedData_5_mantissa == voidData_mantissa)) && (delayedData_5_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_5_mantissa[22 : 15]}) >>> _zz__zz_resMants_5);
      ...
      _zz_resMants_6 <= (((((delayedData_6_signBit == voidData_signBit) && (delayedData_6_mantissa == voidData_mantissa)) && (delayedData_6_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_6_mantissa[22 : 15]}) >>> _zz__zz_resMants_6);
      ...
      _zz_resMants_7 <= (((((delayedData_7_signBit == voidData_signBit) && (delayedData_7_mantissa == voidData_mantissa)) && (delayedData_7_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_7_mantissa[22 : 15]}) >>> _zz__zz_resMants_7);
      ...
      _zz_resMants_8 <= (((((delayedData_8_signBit == voidData_signBit) && (delayedData_8_mantissa == voidData_mantissa)) && (delayedData_8_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_8_mantissa[22 : 15]}) >>> _zz__zz_resMants_8);
      ...
      _zz_resMants_9 <= (((((delayedData_9_signBit == voidData_signBit) && (delayedData_9_mantissa == voidData_mantissa)) && (delayedData_9_exp == voidData_exp)) ? 9'h000 : {1'b1,delayedData_9_mantissa[22 : 15]}) >>> _zz__zz_resMants_9);
