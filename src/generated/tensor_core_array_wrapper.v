...
module tensor_core_array_wrapper (
  ...
  wire       [7:0]    _zz_rdFsm_rdWordCounter_valueNext;
  ...
  reg        [7:0]    rdFsm_rdWordCounter_valueNext;
  reg        [7:0]    rdFsm_rdWordCounter_value;
  ...
  assign _zz_rdFsm_rdWordCounter_valueNext = {7'd0, _zz_rdFsm_rdWordCounter_valueNext_1};
  ...
  assign rdFsm_rdWordCounter_willOverflowIfInc = (rdFsm_rdWordCounter_value == 8'hc7);
  ...
  always @(*) begin
    if(rdFsm_rdWordCounter_willOverflow) begin
      rdFsm_rdWordCounter_valueNext = 8'h0;
    end else begin
  ...
  always @(posedge clk) begin
    if(!clrn) begin
      ...
      rdFsm_rdWordCounter_value <= 8'h0;
