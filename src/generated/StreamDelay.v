...
module StreamDelay (
  ...
  assign when_Misc_l115 = (! outValidReg);
  ...
  assign when_Misc_l121 = (io_outputStream_fire && (! isBufferLoaded));
  ...
  assign when_Misc_l134 = (io_inputStream_fire_4 && (! isBufferLoaded));
  assign io_outputStream_fire_1 = (io_outputStream_valid && io_outputStream_ready);
  assign when_Misc_l124 = (io_outputStream_fire_1 && isBufferLoaded);
  ...
  always @(posedge clk) begin
    if(!clrn) begin
      ...
      if(when_Misc_l115) begin
        outValidReg <= io_inputStream_fire;
      end else begin
        if(when_Misc_l121) begin
          outValidReg <= io_inputStream_fire_2;
        end else begin
          if(when_Misc_l124) begin
            outValidReg <= 1'b1;
